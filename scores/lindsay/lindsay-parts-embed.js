...
for( let i = 0; i < 12; i++ )
{
    ...
    {
        let pngfile = fs.readFileSync(__dirname +  "/reduced/dekompressiongroup"+(i+1)+"-01_"+(j+1)+".png", 'base64');
        _pages.push(`data:image/png;base64,${pngfile}`);
    }
