...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 1007.0, 539.5, 342.0, 318.0 ],
					"presentation_linecount" : 22,
					"text" : "/addr = \"/\"+aseq(1,144),\n\n/sound./key = \"sound\",\n/val./new = \"Player\",\n\n/vars./autostart = \"false\",\n/vars./loop = \"false\",\n/call./method = \"toMaster\",\n\n/val./call = /call,\n/vars./url = \"scores/benjamin/waterdream.mp3\",\n/val./id = \"the_mp3\",\n/val./vars = /vars,\n/sound./val = /val,\n\n\nmap(\n  lambda([a],\n    assign(\"/out\"+a, /sound)\n  ), /addr\n)\n"
				}
